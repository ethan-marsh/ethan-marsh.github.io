  ...
  handleClick = eTarget => {
    ...
    if (this.props.scrollPercent === 0) {
      ...
      scrollNeeded =
        contentTop -
        buttonTop +
        (((100 - this.props.scrollPercent) / 400) * window.innerHeight - 50);
...
const Content = props => (
  <div>
    ...
    >
      {() => props => <animated.h1 style={props} children={'Ethan Marsh'} />}
    </Transition>
    ...
    {
      <ButtonScrollDown onClick={e => props.handleClick(e.currentTarget)}>
        <Transition
          native
