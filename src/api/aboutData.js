...
const aboutSkills = {
    ...
    core: [
        'Javscript, CSS3 (Sass/Stylus)', 'HTML5', 'Mobile & Responsive Design', 'Node.js (basics)', 'MySQL'
    ],
    libraries: [
        'React.js', 'Gulp', 'Wordpress', 'jQuery', 'Bootstrap'
    ]
}
